...
class LLMTranslation(TranslationEngine):
    ...
    def get_system_prompt(self, source_lang: str, target_lang: str) -> str:
        ...
        - The values of json must be a string. If there are quotes in the values of json, they need to be escaped to ensure that the returned json string can be parsed normally.
