                ...
                messages=[
                    {
                        ...
                        "content": [
                            ...
                            # {"type": "text", "text": "The text in the image is Russian, Just only write out the text in this image. Do NOT Translate. Do NOT make extra descriptions. If you can't recognize the text, return an empty string."},
                            {"type": "text", "text": "图片上是俄文,只给用户识别和输出图片上的文字。不要进行翻译也不要给用户多余的解释，如果无法识别你就返回空字符串，返回空字符串就知道你无法识别，所以不用告诉用户你无法识别"},
                        ]
                    }
                ],
                max_tokens=1000,
